...
<head>
    ...
    <title>Editing-<?php echo e($form->name); ?></title>
    ...
    <div class="">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="intro row justify-content-center bg-primary text-light">
                    <div class="col-12">
                        ...
                        <div class="text-center">
                            <img src="<?php echo e(asset('images/logo_bigger_white-1.png')); ?>" height="80vh" class="rounded-lg"
                                alt="<?php echo e(config('zeus.site_title', config('app.name', 'Laravel'))); ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="text-center">
                            <?php if(auth()->guard()->check()): ?>
                                <p><strong>Logged in as <?php echo e(auth()->user()->name); ?></strong></p>
                            <?php endif; ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo e($form->name); ?></h5>
                        <form method="POST" action="<?php echo e(route('entry.update-up', $entry->id)); ?>" accept-charset="UTF-8"
                            enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

                            <?php echo $__env->make('entries.edit-form', ['formMode' => 'edit'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </form>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\bpo-project\resources\views/entries/edit.blade.php ENDPATH**/ ?>