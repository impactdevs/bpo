            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br />
                        <br />
                        <form method="POST" action="<?php echo e(route('settings.update', $currentItem->id)); ?>" accept-charset="UTF-8"
...
<?php endif; ?>
<?php /**PATH D:\bpo\resources\views\settings\edit.blade.php ENDPATH**/ ?>