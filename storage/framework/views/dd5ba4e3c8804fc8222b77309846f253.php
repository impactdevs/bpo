                                ...
                                <?php $__currentLoopData = $forms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-sm font-medium text-left">
                                            <a href="<?php echo e(route('forms.entries', $form->uuid)); ?>"
                                                class="text-blue-600 dark:text-blue-400 hover:underline">
                                                <i class="bi bi-eye"></i>
                                            </a>

                                            <a href="<?php echo e(url('forms/survey', [$form->uuid, auth()->user()->id])); ?>"
...
<?php endif; ?>
<?php /**PATH D:\bpo-project\resources\views/entries/index.blade.php ENDPATH**/ ?>